...
import { Tree, Select, Button, Icon } from 'antd';
import styles  from './TreeTransferLess.less';

// 引入工具方法
import { get, isEmpty, compact, indexOf, difference } from 'lodash';
...
export default class extends Component {
  ...
  dataInit = () => {
    ...
    // 并对父级id去重
    let selectedKeys = []
    self.props.selectedData && self.props.selectedData.map(e => {
