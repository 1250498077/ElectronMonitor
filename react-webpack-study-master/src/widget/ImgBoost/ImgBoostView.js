...
import styles  from './ImgBoostLess.less';
/*
*
* 图片放大组件(新)，使用方法：
* 1. 项目引用该文件  import BoostImg from 'widget/ImgBoost/ImgBoostView';
* 2. 像img标签一样使用就行 <BoostImg src={'xxx'}/>
*/
export default class extends Component {
  ...
  render() {
    ...
    return (
      <div className={styles.indexImgCss} style={{width:this.state.width, height:this.state.height}}>
        <div
